...
public class Unsigned16BitModel implements SourceModel {
	...
	public class Unsigned16BitSymbolModel implements SymbolModel {
		...
		public Unsigned16BitSymbolModel(int value, long init_count, Unsigned16BitModel unsigned16BitModel) {
			_symbol = new Unsigned16BitSymbol(value);
			_count = init_count;
			_model = unsigned16BitModel;
		}
	...
	public Unsigned16BitModel() {
		_values = new Unsigned16BitSymbolModel[65536];
